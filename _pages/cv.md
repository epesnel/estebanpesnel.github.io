...
.cv-date { color: #666; font-size: 0.88em; white-space: nowrap; }
.cv-title { font-weight: 600; font-size: 1.05em; }
.cv-subtitle { color: #555; font-style: italic; margin: 0.15em 0 0.4em 0; }
...
.cv-divider { border: none; border-top: 1px solid #e0e0e0; margin: 0.4em 0 1.2em 0; }
.skill-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 0.5em; margin-bottom: 1em; }
.skill-item { background: #f8f8f8; border-left: 3px solid #4a90d9; padding: 0.3em 0.6em; font-size: 0.88em; }
.highlight-box { background: #f7fbff; border-left: 4px solid #4a90d9; padding: 0.6em 1em; margin: 0.5em 0; font-size: 0.91em; line-height: 1.7; }
.logo { height: 28px; vertical-align: middle; margin-right: 8px; object-fit: contain; }
.skill-cat { font-size: 0.95em; font-weight: 600; margin: 0.8em 0 0.4em 0; }
</style>
...
<div class="cv-subtitle">Université de Rennes &middot; INRIA team COMPACT &middot; MediaKind (CIFRE)</div>
...
<div class="cv-subtitle">École de technologie supérieure (ÉTS) &middot; Montréal, QC, Canada</div>
...
<div class="cv-subtitle">MediaKind &middot; Rennes, France (Hybrid) — CIFRE Partnership with INRIA</div>
<ul>
...
<div class="cv-subtitle">Université de Rennes &middot; Rennes, France (On-site)</div>
<ul>
...
<div class="cv-subtitle">MediaKind &middot; Cesson-Sévigné, France</div>
<ul>
...
<div class="cv-subtitle">Haivision &middot; Rennes, France</div>
<ul>
...
<div class="cv-subtitle">Harmonic &middot; France</div>
